...
function setLanguage(lang) {
    ...
    if (lang === 'ar') {
        pageTitle.textContent = ' نادي التنمية المستدامة يهنئكم بعيد الاضحى المبارك. ولا تنسى معايدةاحبابك';
        ...
        pageTitle.textContent = "The Sustainable Development Club congratulates you on Eid Al-Adha. Don't forget to greet your loved ones";
        nameLabel.textContent = 'Enter your name';
        nameInput.placeholder = "your name";
        generateBtn.textContent = "Open your greeting";
        backgroundSizeLabel.textContent = 'Background Image Size:';
        imagee = "englishcard.png";
